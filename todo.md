...
- [x] Add profile completion progress bar with checklist of missing fields (Created ProfileProgress component with 6 completion criteria)
- [x] Add writing sample collection step to onboarding for AI personalization (Added writing sample screen after review with word count)
- [x] Store writing sample in database for resume/cover letter generation (Added writing_sample column to user_profiles, integrated into onboarding flow)
...
- [x] Add Gender field to profile page (Male, Female, Non-binary, Prefer not to say)
- [x] Add Race/Ethnicity field to profile page (8 options including Prefer not to say)
- [x] Add Veteran Status field to profile page (Yes, No, Prefer not to say)
- [x] Add EEO fields to database schema (gender, race, veteran_status columns)
- [x] Add EEO fields to profile update mutation
- [x] Update job automation to fill EEO fields on AshbyHQ forms
