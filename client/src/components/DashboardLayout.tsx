            ...
            <div className="flex items-center gap-3 px-2 transition-all w-full">
              ...
              {!isCollapsed ? (
                <div className="flex items-center gap-2 min-w-0">
                  <img src="/logo-icon.png" alt="apply.fun" className="h-6 w-6" />
                  <span className="font-semibold tracking-tight truncate bg-gradient-to-r from-purple-500 to-pink-500 bg-clip-text text-transparent">
                    apply.fun
                  </span>
                </div>
              ) : null}
